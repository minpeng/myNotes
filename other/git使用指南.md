...
![avatar](https://img-blog.csdnimg.cn/20191203163902614.png)

> 验证git是否安装成功,在cmd下输入git

![avatar](https://img-blog.csdnimg.cn/20191203163926671.png)
...
19. 给某个commit打标签：git tag -a <tag_name> <commit_id> -m <tag_message>
...
5.测试通过之后,从 master 分支拉出一条 release 分支，例如 release1.0.0，并将qa-name1-name2分支合并到release1.0.0，并部署到预发环境，再次验证以后，均无任何 bug，此时可将 release 分支部署到生产环境
5.待上线完成后,将release分支上同时合并到develop和master分支，并在master分支打上tag，例如v1.0.0
6.当生产环境发现bug时，我们需要从对应的tag上拉出一条hotfix分支(例如hotfix1.0.1).并在hotfix分支上代码合并到develop,master分支，最后，在master分支打上tag(v1.0.1)
  ```
...
![工作流程](https://img-blog.csdnimg.cn/20191203163943721.png)
...
![GitHub](https://img-blog.csdnimg.cn/20191203163935978.png)
...
![小乌龟](https://img-blog.csdnimg.cn/20191203164006865.png)
...
![sourceTree](https://img-blog.csdnimg.cn/20191203163954835.png)
